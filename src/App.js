...
import dbg from "./images/main-img.jpg";
          ...
          <Col>
            <nav className="navbar navbar-expand-lg header-bar">
              ...
              <div className="left-link">
                <span className="nav-link brand">Editor Logo</span>
              </div>
            </nav>
          </Col>
          <Col>
                ...
                <ul className="navbar-nav ml-md-auto">
                  <li className="nav-item active download">
                    <span
                      ...
                      onClick={this.downloadAsJSON}
                    >
                      Export JSON
                    </span>
                  </li>
                  <li className="nav-item active download">
                    <span className="btn btn-fill" onClick={this.downloadAsPNG}>
                      Export Artwork
                    </span>
                  </li>
                  <li className="nav-item">
                    <span className="nav-link btn-close" href="/">
                      <img src={require("./images/close.jpg")} alt="" />
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="canvas-panel">
            ...
            <Footer canvas={this.state.canvas}>
              <ul className="navbar-nav ml-md-auto">
                <li className="nav-item">
                  <a
                    className="nav-link switch"
                    href="{null}"
                    title="Display Grid"
                  >
                    Grid <input type="checkbox" id="gridswitch" />
                    <label htmlFor="gridswitch" onClick={this.showhideGrid}>
                      Toggle
                    </label>
                  </a>
                </li>
                <li className="nav-item">
                  <a
                    ...
                    title="Snap to Grid"
                  >
                    Snap <input type="checkbox" id="snapswitch" />
                    <label htmlFor="snapswitch" onClick={this.setSnap}>
                      Toggle
                    </label>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link switch" href="{null}" title="Overlap">
                    Overlap <input type="checkbox" id="overlapswitch" />
                    <label htmlFor="overlapswitch" onClick={this.setOverlap}>
                      Toggle
                    </label>
                  </a>
                </li>

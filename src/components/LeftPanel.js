...
//import $ from 'jquery';
import pattern1 from "../images/img/pattern1.jpg";
import pattern2 from "../images/img/pattern2.jpg";
import pattern3 from "../images/img/pattern3.jpg";
import pattern4 from "../images/img/pattern4.jpg";
import pattern5 from "../images/img/pattern5.jpg";
import pattern6 from "../images/img/pattern6.jpg";
import pattern7 from "../images/img/pattern7.jpg";
import pattern8 from "../images/img/pattern8.jpg";
import pattern9 from "../images/img/pattern9.jpg";

import initElement1 from "../images/elements/closet.svg";
import initElement2 from "../images/elements/confetti.svg";
import initElement3 from "../images/elements/Email.svg";
import initElement4 from "../images/elements/facebook.svg";
import initElement5 from "../images/elements/gift.svg";
import initElement6 from "../images/elements/hat.svg";
import initElement7 from "../images/elements/fireplace.svg";
import initElement8 from "../images/elements/instagram.svg";
import initElement9 from "../images/elements/dryer.svg";

import icon1 from "../images/elements/circle.svg";
import icon2 from "../images/elements/rectangle.svg";
import icon3 from "../images/elements/square.svg";
import icon4 from "../images/elements/triangle.svg";
import icon5 from "../images/elements/ellipse.svg";

import shape1 from "../images/elements/Party_1233.svg";
import shape2 from "../images/elements/Party_1239.svg";
import shape3 from "../images/elements/Party_1241.svg";
import shape4 from "../images/elements/Party_1242.svg";
import shape5 from "../images/elements/Party_1245.svg";
import shape6 from "../images/elements/Party_1246.svg";

import clipart1 from "../images/elements/logo_1214.svg";
import clipart2 from "../images/elements/logo_1215.svg";
import clipart3 from "../images/elements/logo_1216.svg";
import clipart4 from "../images/elements/logo_1219.svg";
import clipart5 from "../images/elements/logo_1232.svg";
import clipart6 from "../images/elements/logo_1234.svg";
...
const INIT_ELEMENT_ICONS = [icon1, icon2, icon3, icon4, icon5];

const INIT_ELEMENT_SHAPES = [shape1, shape2, shape3, shape4, shape5, shape6];
...
class LeftPanel extends React.Component {
  ...
  pixaybay = () => {
    fetch(
      "https://pixabay.com/api/?key=11095386-871fd43c33a92700d9bffb82d&q=" +
        this.state.searchkey +
        "&image_type=photo&pretty=true&page=" +
        this.state.page +
        "&per_page=24&safesearch=true"
    )
      .then((res) => res.json())
      .then(
        (result) => {
      ...
      <div className="side-panel-container">
        ...
        <TabPanel tabId="vertical-tab-two">
          <Container>
            <Row>
              <Col>
                <p className="btn btn-primary" onClick={this.showUploadPopup}>
                  Upload BG
                </p>
              </Col>
              <Col>
                <p className="btn btn-primary" onClick={this.deleteCanvasBg}>
                  Remove BG
                </p>
              </Col>
            </Row>
                        ...
                        {this.state.unsplashImg.map((photo, index) => {
                          return (
                            <span
                              className="image-wrapper"
                              key={index}
                              onClick={() => this.addImage(photo.urls.small)}
                            >
                              <img
                                className="pixabay"
          ...
          <Container className="text-editer">
            <Row>
              <Col>
                ...
                <p>Elements</p>
                <p className="btn btn-primary" onClick={this.uploadIcon}>
                  Upload Icon
                </p>
